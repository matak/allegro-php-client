...
class PostBuyFormDataStruct
{
    ...
    /**
     * @param int $postBuyFormId
     * @return \Rindeal\Allegro\Client\HttpClient\Wsdl\PostBuyFormDataStruct
     */
